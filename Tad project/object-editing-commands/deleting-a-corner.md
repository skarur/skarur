...
1. Move the helpers to the object whose corner you want to delete.
2. Move the first helper to the corner that you want to delete.
3. On the **Model** menu, click **Delete corner**.
...
_←_ [_∈_](https://docs.teamtad.com/deleting\_a\_corner?do=edit)
