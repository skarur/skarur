...
1. Move the helpers to the object where you want to add a corner.
2. Move the helpers between the edges where you want to insert a corner.
3. Place the architect to the point where you want to add a corner.
4. On the **Model** menu, click **Add a corner**.
...
_←_ [_∈_](https://docs.teamtad.com/adding\_a\_corner?do=edit)
